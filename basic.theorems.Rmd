...
![](graphs/prob06.png)
The proof for a decreasing sequence $\{A_n , n \ge$ \}$ follows directly from the fact that then $\{A^c_n, n \ge 1\}$ is an increasing sequence.
